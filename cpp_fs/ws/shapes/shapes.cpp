...
static double CalcLengthIMP(Point& a_, Point& b_)
{
	return (sqrt(pow(a_.GetY() - b_.GetY(), 2.0) + 
				 pow(a_.GetX() - b_.GetX(), 2.0)));
}
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
static double CalcAngleIMP(Point& a_, Point& b_)
{
...
static Point CalcMidPointIMP(Point& a_, Point& b_)
{
	...
	p_res.SetX((a_.GetX() + b_.GetX()) / 2.0);
	p_res.SetY((a_.GetY() + b_.GetY()) / 2.0);
...
void CalcPointsIMP(Point *arr, double angle, double len, Point &position)
{
	arr[0].SetX(position.GetX() - cos(angle * degToRad) * (len / 2.0));
	arr[0].SetY(position.GetY() - sin(angle * degToRad) * (len / 2.0));
	arr[1].SetX(position.GetX() + cos(angle * degToRad) * (len / 2.0));
	arr[1].SetY(position.GetY() + sin(angle * degToRad) * (len / 2.0));
}
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
void Line::Draw() const
{
	...
	std::cout << "P1 = (" << arr[0].GetX() << "," << arr[0].GetY() << ")" << 
																	std::endl;
	std::cout << "P2 = (" << arr[1].GetX() << "," << arr[1].GetY() << ")" << 
																	std::endl;
	std::cout << "color = "<< GetColor() << std::endl;
	std::cout << "angle = "<< GetAngle() << std::endl;
	std::cout << "center = " << GetPosition().GetX() << "," << 
								GetPosition().GetY() << std::endl;
}
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
void Rectangle::Draw() const
{
	...
	std::cout << "P3 = (" << arr[0].GetX() << "," << arr[0].GetY() << ")" << 
																	std::endl;
	std::cout << "P4 = (" << arr[1].GetX() << "," << arr[1].GetY() << ")" << 
																	std::endl;
