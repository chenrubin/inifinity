...
int main()
{
	...
	PRINTTESTRESULTS("GetNumer",43, 7 == ((r1 + r2).GetNumer()));
	PRINTTESTRESULTS("GetDenomin",44, 2 == ((r1 + r2).GetDenomin()));
	PRINTTESTRESULTS("GetNumer",45, 7 == ((r1 + 3).GetNumer()));
	PRINTTESTRESULTS("GetDenomin",46, 2 == ((r1 + 3).GetDenomin()));
	
	int x = r2;
	double y = r1;
	PRINTTESTRESULTS("GetNumer",47, 3 == x);
	PRINTTESTRESULTS("GetDenomin",48, 0.5 == y);
	r2 = 2;
	PRINTTESTRESULTS("GetNumer",49, 2 == (r2.GetNumer()));
	PRINTTESTRESULTS("GetDenomin",50, 1 == (r2.GetDenomin()));
	
	
	PRINTTESTRESULTS("implicit cast frac to int",49, 3.5 == (3 + r1));
	
	
	Fraction r4(1,2);
	Fraction r5(3);
	
	PRINTTESTRESULTS("GetNumer",51, 5 == ((r5 - r4).GetNumer()));
	PRINTTESTRESULTS("GetDenomin",52, 2 == ((r5 - r4).GetDenomin()));
	PRINTTESTRESULTS("GetNumer",53, -5 == ((r4 - 3).GetNumer()));
	PRINTTESTRESULTS("GetDenomin",54, 2 == ((r4 - 3).GetDenomin()));
	
	PRINTTESTRESULTS("implicit cast frac to int",55, 2.5 == (3 - r4));
